...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.CurrentActivity.ActivityLifecycleContextListener, Plugin.CurrentActivity", ActivityLifecycleContextListener.class, __md_methods);
	}
